...
export default function CarrierSearchPage() {
  ...
  return (
    <div className="space-y-4">
      ...
      {ordersQuery.isLoading || carriersQuery.isLoading ? (
        <LoadingList count={4} />
      ) : ordersQuery.isError || carriersQuery.isError ? (
        <ErrorState
          onRetry={() => {
        ...
        <EmptyState title="Перевозчики не найдены" description="Попробуйте изменить маршрут или параметры груза." />
      ) : (
